'''
    Program to solve linear systems of equations by LU decomposition.
'''

#############################################
# part 1 - find and return the inverse matrix
...
# Part 2 - decompose a matrix into lower and upper triangular matrix
...
# Driver code
size = int(input("enter order of a square matrix : "))
print("enter value after value : ")
matrix = []
...
for i in range(size):
    b_vector.append([0])
    b_vector[i][0] = (input())
    b_vector[i][0] = float(b_vector[i][0])
...
if inverse != 0:
    ...
    y = matrixmult(inverseL, b_vector)
    inverseU_mul_y = matrixmult(inverseU, y)

    print("\nthe result vector - X vector :")
